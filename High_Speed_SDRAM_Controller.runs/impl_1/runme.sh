...
HD_PWD='C:/Users/R ramadevi/OneDrive/Desktop/High_Speed_SDRAM_Controller/High_Speed_SDRAM_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sdram_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sdram_controller_top.tcl -notrace
