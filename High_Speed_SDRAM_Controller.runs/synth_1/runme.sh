...
HD_PWD='C:/Users/R ramadevi/OneDrive/Desktop/High_Speed_SDRAM_Controller/High_Speed_SDRAM_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdram_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdram_controller_top.tcl
